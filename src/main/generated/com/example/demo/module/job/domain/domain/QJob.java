...
public class QJob extends EntityPathBase<Job> {
    ...
    public final com.example.demo.module.payment.domain.QPayment payment;
    ...
    public QJob(Class<? extends Job> type, PathMetadata metadata, PathInits inits) {
        ...
        this.payment = inits.isInitialized("payment") ? new com.example.demo.module.payment.domain.QPayment(forProperty("payment"), inits.get("payment")) : null;
